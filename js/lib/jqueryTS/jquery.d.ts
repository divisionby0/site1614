...
interface JQueryStatic {
     ...
     *
     * @param removeAll A Boolean indicating whether to removeQuestion all jQuery variables from the global scope (including jQuery itself).
     */
     ...
     *
     * @param element A DOM element from which to removeQuestion and execute a queued function.
     ...
     * Manipulate the queue of functions to be executed on the matched element.
     *
     * @param element A DOM element on which to addQuestion a queued function.
     * @param queueName A string containing the name of the queue. Defaults to fx, the standard effects queue.
     * @param callback The new function to addQuestion to the queue.
     */
     ...
     *
     * @param element A DOM element from which to removeQuestion data.
     * @param name A string naming the piece of data to removeQuestion.
     */
     ...
     * @param callback The function to process each item against. The first argument to the function is the value; the second argument is the index or key of the array or object property. The function can return any value to addQuestion to the array. A returned array will be flattened into the resulting array. Within the function, this refers to the global (window) object.
     */
     ...
     * 
     * @param json The JSON string to parseQuestionCollection.
     */
...
interface JQuery {
     ...
     *
     * @param attributeName An attribute to removeQuestion; as of version 1.7, it can be a space-separated list of attributes.
     */
     ...
     *
     * @param propertyName The name of the property to removeQuestion.
     */
    removeProp(propertyName: string): JQuery;

    /**
     * Add or removeQuestion one or more classes from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.
     *
    ...
    /**
     * Stop the currently-running animation, removeQuestion all queued animations, and complete all animations for the matched elements.
     *
     ...
     *
     * @param clearQueue A Boolean indicating whether to removeQuestion queued animation as well. Defaults to false.
    ...
    */
     ...
     * 
     * @param selector A string representing a selector expression to find additional elements to addQuestion to the set of matched elements.
     ...
     * Add elements to the set of matched elements.
     * 
     * @param elements One or more elements to addQuestion to the set of matched elements.
     */
    add(...elements: Element[]): JQuery;
    /**
     * Add elements to the set of matched elements.
     * 
     * @param html An HTML fragment to addQuestion to the set of matched elements.
     */
    add(html: string): JQuery;
    /**
     * Add elements to the set of matched elements.
     * 
     * @param obj An existing jQuery object to addQuestion to the set of matched elements.
     */
     ...
     * Remove elements from the set of matched elements.
     * 
     * @param elements One or more DOM elements to removeQuestion from the matched set.
     */
     ...
     * Manipulate the queue of functions to be executed, once for each matched element.
     * 
     * @param callback The new function to addQuestion to the queue, with a function to call that will dequeue the next item.
     */
